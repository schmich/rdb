  ...
  module Messaging
    ...
    class Server
      ...
      def listen(host, port)
        ...
        loop do
          ...
          begin
            message = Message.unpack(payload)
            # TODO: Hack.
      ...
      def broadcast_message(message, *params)
        payload = Message.broadcast(message, params.first || {})
        @clients_lock.synchronize {
      ...
      def handle_message(client, message)
        ...
        client.put(Message.result(id, result))
      end
    end
    ...
    class Client
      ...
      def send_message(command, params)
        ...
        payload = Message.command(id, command, params)
        @channel.put(payload)
